			...
			setTimeout(function() {
				...
				if (self.arrayPos < self.strings.length){
					...
					if (curStrPos > curString.length && self.arrayPos < self.stopArray){
						...
						// if looping is false, and we are at the last string, execute the callback
						if (self.loop === false && self.arrayPos === self.stopArray && curStrPos === curString.length){
							var clear = self.options.callback();
							clearTimeout(clear);
						}
					}
				}
				// reset the typing when we finish the loop
